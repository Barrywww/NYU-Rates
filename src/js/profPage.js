...
class LikeBtn extends React.Component{
    /**
     * LikeBtn class，the like button for the professor comment
     * @constructor
...
class DisLikeBtn extends React.Component{
    /**
     * DisLikeBtn class，the dislike button for the professor comment
     * @constructor
     * @param {object} state - whether the student dislike the comment or not and the current number of the dislikes for the comment
     */
    constructor(props){
        super(props)
        this.state={
    ...
    isdislike =()=>{
        /**
         * dislike the course and change the number of the dislikes for the comment
         */
...
class ProfPage extends React.Component{
    /**
     * ProfPage class, the information page for the professor\
     * @constructor
     * @param {object} state - current professor info
     */
    constructor(props){
        super(props)        
